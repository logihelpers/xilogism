text_values = {
    ...
    # Start Page
    "text_newxilo": "CRAFT MY XILOGISM SKIBIDI\n",
    "format": "Pseudocode Vibe Check",
    "text_openxilo": "YOINK EXISTING",
    "get_your_hands_dirty": "GET MESSY WITH THE\n",
    "tagline": "CODE TO CIRCUITS, XILOGISM GO BRRR!",

    "greetings": "Yo what's good, homie!",
    "search": "Snipe that search",
    "pinned_projects": "Locked-in Projects",
    "local_projects": "Local Drip",

    "viewing_mode": "Vibe Check Mode:",
    "blank_content_tooltip": "Content's straight up empty, fam...",
    "correct_content_tooltip": "Content's bussin', no cap...",
    "wrong_content_tooltip": "Content's got mad errors, yeet...",

    "hide_sidebar_tooltip": "Yeet the sidebar",
    "show_sidebar_tooltip": "Pop the sidebar back",
    "tutorial_tooltip": "App Tutorial, let's get lit",
    "settings_tooltip": "App Settings, tweak the vibes",
    "user_settings_tooltip": "User vibes, customize your drip",
    "minimize_tooltip": "Shrink the app, lowkey mode",
    "maximize_tooltip": "Big app energy, full screen",
    "close_tooltip": "Bounce from the app",
    "default_title": "VIBE CHECK",

    "hide_group": "Yeet the Group",
    "reload": "Refresh the Vibes",

    "home_title": "Main Vibe",
    "pinned_title": "Locked In",
    "local_files_title": "Local Drip",
    "gdrive_title": "Google Drive, Skibidi Style",
    "guest_user": "Rando User",

    "language_title": "Vibe Lingo",

    "dark_mode_title": "Dark Mode Vibe",
    "accent_color_title": "Drip Color",
    "editor_theme_title": "Editor Glow-Up",
    "custom_background_title": "Custom Drip Background",
    "follow_system_label": "Sync with System Dark Mode, No Cap:      ",
    "use_default_button": "Rock the OG Look",
    "choose_image_button": "Pick a Lit Pic",
    "source_path": "Where the Drip At:",
    "default_theme": "Basic Vibe",
    "dark_theme": "Shadow Mode",

    "dyslexia_friendly_title": "Dyslexia-Friendly Vibes",
    "left_handed_title": "Left-Handed Drip",
    "animation_settings_title": "Animation Glow-Up",
    "keyboard_shortcuts_title": "Keyboard Hacks",
    "animations_label": "Animations, Skibidi Style:      ",
    "default_dyslexia": "Basic Vibe",
    "readable_dyslexia": "Big Brain Readable",
    "default_sidebar": "OG Sidebar",
    "left_handed_sidebar": "Lefty Swag",
    "hide_sidebar_action": "Yeet Sidebar",
    "save_xilogism_action": "Lock in Xilogism",
    "hide_sidebar_shortcut": "Ctrl + \\",
    "save_xilogism_shortcut": "Ctrl + S",

    "export_label": "Yeet",

    "finish_button": "Donezo",
    "previous_button": "Back It Up",

    "appearance_label": "Drip Settings",
    "accessibility_label": "Access Vibes",
    "language_label": "Lingo",
    "close_button": "Yeet Out",

    "register_title": "Join the Squad",
    "create_account": "Make a Lit Account",
    "sign_up_google": "ROLL UP WITH GOOGLE",
    "name_field": "Drip Tag",
    "email_field": "E-Vibe",
    "password_field": "Secret Code",
    "register_button": "LOCK IT IN",
    "sign_in_link": "Already in the gang? Slide in",
    ...
    "please_login": "Log in to keep the vibe goin'",
    "email_field": "E-Vibe",
    "password_field": "Secret Code",
    "forgot_password": "Yeeted your password?",
    "login_button": "LOCK IN",
    "google_login_button": "ROLL UP WITH GOOGLE",
    "sign_up_link": "No account? Join the squad",
    "fill_fields_error": "Fill in the e-vibe and secret code, fam.",
    "email_reset_error": "Drop your e-vibe to reset the code.",
    "password_reset_title": "Code Reset",
    "password_reset_message": "Sent a reset link to your e-vibe. Check your inbox, no cap.",
    "ok_button": "Bet",

    "export_title": "Yeet Xilogism",
    "file_format_label": "File Vibe:",
    "page_size_label": "Page Drip:",
    "project_name_label": "Project Tag:",
    "creator_label": "Big Brain:",
    "date_label": "When It Dropped:",
    "margin_label": "Edge Game:",
    "title_block_label": "Title Glow-Up:",
    "export_button": "Send It",
    "print_button": "Print It",
    "cancel_button": "Nah, I'm Out",
    "project_name_hint": "like Xilogism 1, fam",
    "creator_hint": "like User, no cap",
    "date_hint": "like 04/07/2025, bet",
    "pdf_option": "PDF",
    "png_option": "PNG",
    "docx_option": "DOCX",
    "raw_png_option": "RAW_PNG",
    "letter_option": "Letter 8.5 x 14 in, Skibidi",
