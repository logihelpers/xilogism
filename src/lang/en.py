text_values = {
    ...
    # Start Page
    "text_newxilo": "CREATE MY XILOGISM\n",
    "format": "Pseudocode Format",
    "text_openxilo": "OPEN EXISTING",
    "get_your_hands_dirty": "GET YOUR HANDS DIRTY WITH\n",
    "tagline": "CODES TO CIRCUITS, XILOGIZED!",
    ...
    "blank_content_tooltip": "Content is currently blank...",
    "correct_content_tooltip": "Content is correct...",
    "wrong_content_tooltip": "Content is containing errors...",

    "hide_sidebar_tooltip": "Hide the side bar",
    "show_sidebar_tooltip": "Show the side bar",
    "tutorial_tooltip": "Application Tutorial",
    "settings_tooltip": "Application Settings",
    "user_settings_tooltip": "User settings",
    "minimize_tooltip": "Minimize the app",
    "maximize_tooltip": "Maximize the app",
    "close_tooltip": "Close the app",
    "default_title": "START",
    ...
    "editor_theme_title": "Editor Theme",
    "custom_background_title": "Custom Background",
    "follow_system_label": "Follow System Dark Mode Settings:      ",
    "use_default_button": "Use Default",
    "choose_image_button": "Choose Image",
    "source_path": "Source Path:",
    "default_theme": "Default",
    "dark_theme": "Dark",

    "dyslexia_friendly_title": "Dyslexia-Friendly Options",
    "left_handed_title": "Left-Handed Mode",
    "animation_settings_title": "Animation Settings",
    "keyboard_shortcuts_title": "Keyboard Shortcuts",
    "animations_label": "Animations:      ",
    "default_dyslexia": "Default",
    "readable_dyslexia": "Readable",
    "default_sidebar": "Default",
    "left_handed_sidebar": "Left-Handed",
    "hide_sidebar_action": "Hide Sidebar",
    "save_xilogism_action": "Save Xilogism",
    ...
    "fill_fields_error": "Please fill in both email and password.",
    "email_reset_error": "Please enter your email to reset password.",
    "password_reset_title": "Password Reset",
    "password_reset_message": "We've sent a reset link to your email. Please check your inbox.",
    "ok_button": "OK",

    "export_title": "Export Xilogism",
    ...
    "date_label": "Date:",
    "margin_label": "Margin:",
    "title_block_label": "Title Block:",
    "export_button": "Export",
    "print_button": "Print",
    "cancel_button": "Cancel",
    "project_name_hint": "e.g. Xilogism 1",
    "creator_hint": "e.g. User",
    "date_hint": "e.g. 04/07/2025",
    "pdf_option": "PDF",
    "png_option": "PNG",
    "docx_option": "DOCX",
    "raw_png_option": "RAW_PNG",
    "letter_option": "Letter 8.5 x 14 in",
