        ...
        try:
            ...
            for button in AccentColorButton.refs:
                if button.color == active:
                    ...
                    button.main_content.border = border.all(1.5, divider_color)
                    button.main_content.update()

                    button.main_content.content.value = "✓"
                    button.main_content.content.color = text_color
                    ...
                    button.main_content.border = border.all(0.5, divider_color)
                    button.main_content.update()
